...
We can implement a min-heap using a list to represent the underlying tree structure. This approach is memory-efficient and leverages Python's built-in list operations for ease of implementation.
